...
export interface Leao extends Container {
  ...
  register(): Promise<Leao>;
  bootstrap(): Promise<Leao>;
...
export interface LeaoDirectories {
  static: {
    public: string;
  };
  app: {
