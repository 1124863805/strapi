...
import { ILocalLeaoSourceProviderOptions } from '../local-source';
import { createDispatcher, connectToWebsocket, trimTrailingSlash, wait, waitUntil } from '../utils';

export interface IRemoteLeaoSourceProviderOptions extends ILocalLeaoSourceProviderOptions {
...
class RemoteLeaoSourceProvider implements ISourceProvider {
  name = 'source::remote-leao';

  type: ProviderType = 'source';

  options: IRemoteLeaoSourceProviderOptions;

  ws: WebSocket | null;

  dispatcher: ReturnType<typeof createDispatcher> | null;

  constructor(options: IRemoteLeaoSourceProviderOptions) {
...
export const createRemoteLeaoSourceProvider = (options: IRemoteLeaoSourceProviderOptions) => {
  return new RemoteLeaoSourceProvider(options);
};
