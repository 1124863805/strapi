...
describe('Box', () => {
  ...
  describe('Polymorphic component', () => {
    ...
    it('should render and accept attributes when the as prop is `a`', () => {
      ...
      const { container, rerender } = render(<Box href="https://leao.io" />);

      rerender(<Box tag="a" href="https://leao.io" />);
      expect(container.firstChild).toHaveAttribute('href', 'https://leao.io');
    });
    ...
    it('should render and accept props from the component when passed as the `as` prop', () => {
      ...
      const { container, rerender } = render(<Box to="https://leao.io" />);

      rerender(<Box tag={MyLink} to="https://leao.io" />);
      expect(container.firstChild).toHaveAttribute('href', 'https://leao.io');
    });
    ...
    it('should allow me to pass different refs', () => {
      const MyLink = () => {
        ...
        return (
          <Box tag="a" href="https://leao.io" ref={linkRef}>
            click me!
          </Box>
        );
      };
