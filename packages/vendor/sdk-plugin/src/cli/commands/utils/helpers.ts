...
export const dirContainsLeaoProject = (dir: string) => {
  try {
...
export const getPkgManager = (options: CommonCLIOptions, isLeao: boolean) => {
  // if we are in a leao project we return it's package manager
  if (isLeao) {
