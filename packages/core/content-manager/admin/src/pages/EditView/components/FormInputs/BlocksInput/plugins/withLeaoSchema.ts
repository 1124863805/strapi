...
/**
 * This plugin is used to normalize the Slate document to match the Leao schema.
 */
const withLeaoSchema = (editor: Editor) => {
  const { normalizeNode } = editor;

  /**
   * On the leao schema, we want text nodes to have type: text
