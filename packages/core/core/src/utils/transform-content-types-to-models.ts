...
/**
 * Because leao/database models don't know about things like components or dynamic zones, we use this file to convert them
...
// Transforms an attribute (particularly for relation types) into the format that leao/database accepts
