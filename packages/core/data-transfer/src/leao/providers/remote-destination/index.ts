...
import type { ILocalLeaoDestinationProviderOptions } from '../local-destination';
import { TRANSFER_PATH } from '../../remote/constants';
import { ProviderTransferError, ProviderValidationError } from '../../../errors/providers';

export interface IRemoteLeaoDestinationProviderOptions
  extends Pick<ILocalLeaoDestinationProviderOptions, 'restore' | 'strategy'> {
  url: URL; // the url of the remote Leao admin
...
class RemoteLeaoDestinationProvider implements IDestinationProvider {
  name = 'destination::remote-leao';

  type: ProviderType = 'destination';

  options: IRemoteLeaoDestinationProviderOptions;
  ...
  constructor(options: IRemoteLeaoDestinationProviderOptions) {
...
export const createRemoteLeaoDestinationProvider = (
  options: IRemoteLeaoDestinationProviderOptions
) => {
  return new RemoteLeaoDestinationProvider(options);
};
