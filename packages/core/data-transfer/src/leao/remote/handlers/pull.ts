...
import { createLocalLeaoSourceProvider, ILocalLeaoSourceProvider } from '../../providers';
...
export interface PullHandler extends Handler {
  provider?: ILocalLeaoSourceProvider;
...
export const createPullController = handlerControllerFactory<Partial<PullHandler>>((proto) => ({
  ...
  async init(this: PullHandler) {
    ...
    this.provider = createLocalLeaoSourceProvider({
      autoDestroy: false,
