...
describe('Typography', () => {
  ...
  describe('Polymorphic component', () => {
    ...
    it('should render and accept attributes when the as prop is `a`', () => {
      ...
      const { rerender } = render(<Typography href="https://leao.io" />);

      rerender(
        <Typography tag="a" href="https://leao.io">
          Leao
        </Typography>,
      );
      expect(screen.getByText('Leao')).toHaveAttribute('href', 'https://leao.io');
    });
    ...
    it('should render and accept props from the component when passed as the `as` prop', () => {
      ...
      const { rerender } = render(<Typography to="https://leao.io" />);

      rerender(
        <Typography tag={MyLink} to="https://leao.io">
          Leao
        </Typography>,
      );
      expect(screen.getByText('Leao')).toHaveAttribute('href', 'https://leao.io');
    ...
    it('should allow me to pass different refs', () => {
      const MyLink = () => {
        ...
        return (
          <Typography tag="a" href="https://leao.io" ref={linkRef}>
            click me!
          </Typography>
        );
      };
