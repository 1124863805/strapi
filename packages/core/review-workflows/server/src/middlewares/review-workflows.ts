...
/**
 * A Leao middleware function that adds support for review workflows.
 *
 * Why is it needed ?
 ...
 *
 * @param {object} leao - The Leao instance.
 */
export function contentTypeMiddleware(leao: Core.Leao) {
  /**
  ...
  leao.server.router.use('/content-type-builder/content-types/:uid?', (ctx, next) => {
